...
customKeyword:
  '全局关键字': '全局关键字回复 [$img](https://api.sunweihu.com/api/sjbz/api.php)'  # 使用内部标签 img 返回图片，可参考配置手册
...
periodicTask:
  ...
  - groupId: '903025723'    # 定时任务发送消息的群
    ...
    content: |-             # 发布的内容，|- 是 yaml 的语法。这允许字符串换行
      你好呀！我很喜欢你
      晚安!
    image: true             # 是否在消息末尾附加一张随机美图, 此功能等同于使用内部标签，后续版本获将废弃
  ...
  - groupId: '903025723'    # 定时任务发送消息的群
    ...
    content:           # 如果内容为列表，机器人会随机选择发送
      - |-             # 发布的内容，|- 是 yaml 的语法。这允许字符串换行
        [mirai:face:317]
        [$img](https://api.sunweihu.com/api/sjbz/api.php)
      - |-             # 发布的内容，|- 是 yaml 的语法。这允许字符串换行
        呃....
        额....
        饿....
        [$img](https://api.sunweihu.com/api/sjbz/api.php)
        [$img](http://h1.ioliu.cn/bing/HallesWood_ZH-CN9790575479_1920x1080.jpg?imageslim)
        [$img](test.png)
        上述演示了内部标签 img 的用法，可参考配置手册
    image: false       # 此功能等同于使用内部标签，后续版本获将废弃
