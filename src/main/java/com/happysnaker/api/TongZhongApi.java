...
public class TongZhongApi {
    ...
    public static String url1 = "https://tonzhon.com/api/search?keyword=";
    public static String url2 = "https://tonzhon.com/secondhand_api/song_source/platform/id";
    public static String url3 = "https://tonzhon.com/secondhand_api/search?provider=kuwo&keyword=";
    public static String url4 = "https://tonzhon.com/secondhand_api/search?provider=qq&keyword=";
    public static String url5 = "https://tonzhon.com/secondhand_api/search?provider=netease&keyword=";
...
//            MusicKind neteaseCloudMusic = MusicKind.NeteaseCloudMusic;
            ...
            songs.addAll(getSongs(keyword, url1));
