...
如果你需要砍公骑冠剑相关或**更多高级功能**，那么您必须配置相关信息，请移步 [配置文件手册](./CONFIG.md)
...
| #订阅               | #订阅 bilibili 0 384136794 qq1 qq2 qq3 ... | 命令格式 #订阅  平台  类型  KEY  At成员列表，与配置文件中配置对齐，可前往 [配置文件模板](./CONFIG.md) 查看说明，其中 pushGroup 会被设置为发送者所在的群。 | 至少是群管理员权限                                   |
