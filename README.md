...
**表格展示为最新版 v3.2 插件功能，默认情况下，与机器人聊天需要@机器人，而其他关键字都无须 @，详情请查看下表中的“示例”，你可以在 [历史版本关键字及命令](./HISTORY_VERSION.md) 中找到历史版本对应关键字，在配置文件中你可以选择关闭 @。**
...
下表展示最新版插件 v3.3 插件功能，你可以在 [历史版本关键字及命令](./HISTORY_VERSION.md) 中找到历史版本对应信息。
